...
#define HR_N RGUI_T(KC_SCLN)

[_QWERTY] = LAYOUT(
KC_GRV,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  TG(_GAMING),
KC_TAB,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                     KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,      KC_BSPC,
KC_ESC,   HR_A,   HR_S,    HR_D,    HR_F,    KC_G,                     KC_H,    HR_J,    HR_K,    HR_L,    HR_N,      KC_QUOT,
...
// Gaming layout without home-row modifiers. switched spc & ent

[_GAMING] = LAYOUT(
KC_GRV,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  TG(_GAMING),
KC_TAB,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                     KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,      KC_BSPC,
KC_ESC,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    KC_N,      KC_QUOT,
KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,   KC_M, KC_COMM,  KC_DOT, KC_SLSH,      KC_RSFT,
               KC_LGUI,KC_LALT,KC_LCTL, MO(_LOWER), KC_SPC,      KC_ENT,  MO(_RAISE), KC_RCTL, KC_RALT, KC_RGUI
),

/* LOWER
Symbols/F keys/Numpad layout
* ,-----------------------------------------.                    ,-----------------------------------------.
...
/* RAISE
Navigation & other layout
* ,----------------------------------------.                    ,-----------------------------------------.
* |      |      |      |      |      |      |                    |      |      |      |      |      |      |
* |------+------+------+------+------+------|                    |------+------+------+------+------+------|
* | Esc  | Ins  | Pscr | Menu |      |      |                    | PWrd | PGdn | PGup | NWrd |      | Bspc |
* |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
_______,  KC_INS,  KC_PSCR,   KC_APP,  XXXXXXX, XXXXXXX,                            KC_PGUP,  KC_PGDN, KC_PGUP, KC_NXTWD,  XXXXXXX, KC_BSPC,
_______, KC_LALT,  KC_LCTL,  KC_LSFT,  XXXXXXX, KC_CAPS,                            KC_LEFT,  KC_DOWN,   KC_UP,  KC_RGHT,   KC_DEL, KC_BSPC,
_______,KC_UNDO, KC_CUT, KC_COPY, KC_PASTE, XXXXXXX,  _______,            _______,  KC_LSTRT, XXXXXXX, XXXXXXX,  KC_LEND,   XXXXXXX, _______,
                    _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
